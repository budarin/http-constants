...
export const HEADER_CONTENT_SECURITY_POLICY_REPORT_ONLY =
    'Content-Security-Policy-Report-Only';
export const HEADER_STRICT_TRANSPORT_SECURITY = 'Strict-Transport-Security';
export const HEADER_X_CONTENT_TYPE_OPTIONS = 'X-Content-Type-Options';
...
export const HEADER_ACCESS_CONTROL_ALLOW_CREDENTIALS =
    'Access-Control-Allow-Credentials';
export const HEADER_ACCESS_CONTROL_ALLOW_HEADERS =
    'Access-Control-Allow-Headers';
export const HEADER_ACCESS_CONTROL_ALLOW_METHODS =
...
export const HEADER_ACCESS_CONTROL_REQUEST_HEADERS =
    'Access-Control-Request-Headers';
export const HEADER_ACCESS_CONTROL_REQUEST_METHOD =
...
// Compression headers
export const HEADER_ACCEPT_ENCODING_HEADER = 'Accept-Encoding';
export const HEADER_CONTENT_ENCODING_HEADER = 'Content-Encoding';

// WebSocket headers
export const HEADER_SEC_WEBSOCKET_KEY = 'Sec-WebSocket-Key';
export const HEADER_SEC_WEBSOCKET_ACCEPT = 'Sec-WebSocket-Accept';
export const HEADER_SEC_WEBSOCKET_VERSION = 'Sec-WebSocket-Version';
export const HEADER_SEC_WEBSOCKET_PROTOCOL = 'Sec-WebSocket-Protocol';
